...
if data_option == "Charger mes données" and uploaded_file is not None:
...
if df is not None:
    ...
    with tabs[2]:  # Prédiction
        ...
        if predict_button and st.session_state.model_trained:
            ...
            # Ajouter la trajectoire idéale (ligne droite)
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 70vh; text-align: center;">
            ...
            <div style="background-color: #EBF5FF; padding: 1rem; border-radius: 6px; max-width: 600px; margin-top: 1rem;">
                <p style="margin: 0; color: #1A56DB;">
                    <strong>Format attendu</strong>: Un fichier CSV contenant les colonnes suivantes:
                    profondeur_finale, azimuth_initial, inclinaison_initiale, lithologie, vitesse_rotation, deviation_azimuth, deviation_inclinaison
                </p>
            </div>
